...
const manifestStyles = require("./src/data/manifest-styles.json");
const cssURL = "build/css/" + manifestStyles["App.css"];
...
if (!IS_DEV) {
  ...
  config.plugins = [
    ...
    new HtmlWebpackPlugin({
      title: 'Guide to applying for unemployment benefit',
      template: './src/client/template.html',
      inject: 'body'
    }),
    new HtmlWebpackTagsPlugin({ tags: [cssURL], append: true }),
    new CopyPlugin({
      patterns: [
        {
